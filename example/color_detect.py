...
def color_detect(img, color_name):
    ...
    if color_area_num > 0:
        for i in contours:  # Traverse all contours
            ...
            if (
                w >= 8 and h >= 8
            ):  # Because the picture is reduced to a quarter of the original size, if you want to draw a rectangle on the original picture to circle the target, you have to multiply x, y, w, h by 4.
                x = x * 4
                y = y * 4
                w = w * 4
                h = h * 4
                ...
                cv2.putText(
                    img, color_type, (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2
